...
df_result = df_adult.select(
  df_adult['education'], 
  # create a 1/0 type col on the fly
  when( col('marital_status') == ' Never-married' , 1 ).otherwise(0).alias('bachelor'))# fill in here
...
rf = RandomForestClassifier(numTrees=100, maxDepth=2, labelCol="label", seed=42) # fill in here
